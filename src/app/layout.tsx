...
export const metadata = {
  ...
  keywords:
    "купить, дешево, каталог, оптом, ювелирные изделия, кольца, часы, драгоценности, онлайн покупки, товары, DukenApp, каталог товаров, интернет-магазин, выгрузка товаров",
  openGraph: {
    title: "DukenApp - Удобный каталог ювелирной изделии",
    description:
  ...
  twitter: {
    ...
    title: "DukenApp - Удобный каталог ювелирных изделий",
    description:
